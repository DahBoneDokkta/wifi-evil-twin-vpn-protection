...
The goal was to explore **security risks in open Wi-Fi networks**, focusing on *Evil Twin*, and to test how **VPN encryption** can protect user data against Man-in-the-Middle exploits.
